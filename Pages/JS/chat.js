...
const API_KEY = "AIzaSyDtg3c590yyegkeHEiL8-UfWajQRFa_Z5I"; // Ensure this is a valid key
const API_MODEL = "gemini-1.5-flash"; // Changed from 2.5 to 1.5
let MAX_RETRIES = 5;
...
if (inputData) {
  ...
  const geminiPrompt = {
    ...
    intent_detection: {
      ...
      notes: ["When QUIZ is requested include correct answers in a JSON block in the top HTML comment. make sure the quiz can be scrolled", "Favor clarity and avoid unnecessary jargon."]
    },
    quiz_metadata: {
